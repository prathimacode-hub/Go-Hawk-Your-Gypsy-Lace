...
class FlaskTests(TestCase):
    ...
    def test_about_route(self):
        ...
        self.assertEqual(result.status_code, 200)
        self.assertIn(b'<h2>About **Go Hawk Your Gypsy Lace**</h2>', result.data) 
    

    def test_login_process(self):
        """Test login process page"""
        result = self.client.post("/login_process", 
            data={"email":"prathimak569@gmail.com", "password":"Kprathima@88"},
            follow_redirects="True")
        self.assertIn(b"Hello, Prathima Kadari!", result.data)


    def test_signup_process(self):
        """test signup process"""
        result = self.client.post("/signup_process", 
        data={"fname":"Moon", "lname":"Light", "email":"Moonlight994844@gmail.com", "password":"Nightowl44"},
        follow_redirects="True")
...
class FlaskTestsLoggedIn(TestCase):
    ...
    def test_render_map(self):
        ...
        self.assertEqual(result.status_code, 200)
        self.assertIn(b"<h2>Hyderabad</h2>", result.data) 
    ...
    def test_make_map_process(self):
        ...
        result = self.client.get("/make_map_process",
            query_string={"map_name":"Hyderabad", "map_description":"Hyderabad activities"},
            follow_redirects="True")
        self.assertEqual(result.status_code, 200)
        self.assertIn(b"<h2>Hyderabad</h2>", result.data)
    ...
    def test_save_location(self):
        ...
        result = self.client.post("/map/1/save",
            data={"title":"Golconda Fort at Hyderabad", 
                    ...
                    "latitude":"17° 22' 59.99",
                    "longitude":"78° 24' 8.99",
                    "user_notes":"Good place to spend a day out"},
            follow_redirects="True")
        self.assertEqual(result.status_code, 200)
        self.assertIn(b'<a class="place-name" href="/" data-name="Golconda Fort at Hyderabad">Golconda Fort at Hyderabad</a>', result.data)
    ...
    def test_delete_location(self):
        ...
        result = self.client.post('/map/1/delete',
            ...
            follow_redirects="True")
        self.assertEqual(result.status_code, 200)
        self.assertNotIn(b'<a class="place-name" href="/" data-name="Hussain Sagar Lake">Hussain Sagar Lake</a>', result.data)
    ...
    def test_get_latitude_and_longitude_for_one_user(self):
        ...
        self.assertEqual(result.status_code, 200)
        self.assertIn(b'{"latitude":17.3850,"longitude":78.4867}', result.data)
...
class FlaskTestsJSON(TestCase):
    ...
    def test_get_places(self):
        ...
        result = self.client.get('/get_places/',
            ...
            follow_redirects="True")
        self.assertEqual(result.status_code, 200)
        self.assertIn(b'{"Khair Complex, Ibrahim Bagh, Hyderabad, Telangana 500008"', result.data)
    ...
    def test_get_last_place_added(self):
        ...
        result = self.client.get('/get_last_place_added/',
            ...
            follow_redirects="True")
        self.assertEqual(result.status_code, 200)
        self.assertIn(b'"latitude":17.3850', result.data)
